...
export function easterEgg(input, context = {}) {
  ...
  if (/super\s*pm|超级产品经理|彩蛋|easter\s*egg/.test(text)) return { found: true, id: "product-lens", message: "彩蛋：真正稀缺的不是更多点子，而是一个愿意被证据推翻的决定。" };
  if (completed >= 7) return { found: true, id: "seven-lenses", message: "你已经完成七个决定。七不是终点，只是终于可以少问一个问题的信号。" };
  return { found: false, id: null, message: "" };
}
